#!/bin/bash
clear
echo -e "\e[4;31m Harshil Productions !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m Co-Attack \e[0m"
...
echo This Script Was Made By Harshil >update.speedx
...
echo -e "\e[1;32m Co-Attack Will Restart Now..."
